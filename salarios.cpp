...
void Salarios::calcular()
{
    ...
    if (nombre == " " || horas == 0 ){
        /*
           ...
           msgBox.setIcon(QMessageBox::Advertencia);
           msgBox.exec();
           */
        QMessageBox::warning ( this , tr(" Advertencia ") , tr(" El nombre o el numero de horas esta vacio "));
        return ;
    }
    ...
    if ( m_controlador-> calcularSalario ()){
        ...
        ui-> statusbar -> showMessage( tr(" Calculos procesados ​​para ") + nombre, 5000 );
    } else {
        QMessageBox::critical( this ,
                               tr(" Error ") ,
                               tr(" Error al calcular el salario. ") );
    }
}
